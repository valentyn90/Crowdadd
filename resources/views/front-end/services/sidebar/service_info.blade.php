...
{{--        <div class="wt-ratingcontent">
      ...
      <hire-freelancer
         ...
         :service="{{ $service }}"
         :service_note="'{{ trans('lang.service_note') }}'"
         :hire_service_title="'{{ trans('lang.hire_service_title') }}'" 
         :hire_service_text="'{{ trans('lang.hire_service_text') }}'"
         :buy_now="'{{ trans('lang.buy_now') }}'">
      </hire-freelancer>
